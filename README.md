...
## Descrizione
Applicazione e-commerce sviluppata per la gestione di un catalogo prodotti, navigazione tramite menu e carrello acquisti basato su sessioni PHP.

## Funzionalità implementate
- **Catalogo:** Visualizzazione dei prodotti dal database.
- **Carrello:** Gestione acquisti in sessione (aggiunta, rimozione singola, svuotamento totale).
- **Navigazione:** Menu dinamico con inclusione PHP.
- **Totali:** Calcolo automatico dei prezzi nel carrello.
